...
def add_feature(orcid, paper1_id, author_names):
    ...
    total_title_scibert_sim, total_abstract_scibert_sim, total_title_and_abstract_scibert_sim, total_keyword_scibert_sim, total_venue_scibert_sim = get_total_similarity(scibert_paper_embedding, paper1_id, other_scibert_papers)
    ...
    return  [
        total_w_cotitle, total_w_coauthor, total_w_coorg, total_w_coabstract, total_w_cokeywords, total_w_covenue, co_auther, co_auther_org, co_venu, co_keywords,
        total_title_bge_sim, total_abstract_bge_sim, total_title_and_abstract_bge_sim, total_keyword_bge_sim, total_venue_bge_sim, 
        total_title_scibert_sim, total_abstract_scibert_sim, total_title_and_abstract_scibert_sim, total_keyword_scibert_sim, total_venue_scibert_sim,
        total_oagbert_sim
    ]
